...
<div class="flex flex-col bg-white">
  ...
  >
    ...
    <article class="flex-1 flex flex-col gap-12 lg:gap-24">
      <!-- ヒーロー画像 -->
      <div
        class="relative aspect-[941/480] w-full overflow-hidden rounded-2xl border border-border-primary bg-[#697065]"
      >
        <img
          src={project.image}
          alt={project.title}
      ...
      <section id="overview" class="flex flex-col gap-4 scroll-mt-20">
        ...
        <img
          src="/project/real-estate/overview-thumbnail.webp"
          alt="不動産業界コーポレートサイトリニューアルのコンセプト：迷わずに目的へ辿り着く、理解しやすいサイト構成でユーザー認知負荷を軽減"
          width="782"
          height="556"
      ...
      <section id="background" class="flex flex-col gap-4 scroll-mt-20">
        ...
        <img
          src="/project/real-estate/background-issues.webp"
          alt="現行サイトの課題分析：会社情報・事業情報・採用情報が同列に並び、タイトルからコンテンツが想像しづらく、採用やお問い合わせなどのCTAがユーザーの目に入りづらい"
          width="1173"
          height="873"
          class="w-full rounded-lg"
          loading="lazy"
          ...
          <ol class="flex flex-col gap-3">
            {#each project.detail.background.userProblems as problem, index (index)}
              <li class="flex items-start gap-3">
                <span
                  class="shrink-0 font-body text-xl font-bold leading-tight text-brand-green tabular-nums"
                >
                  {String(index + 1).padStart(2, '0')}
                </span>
                <span
                  class="font-body text-sm leading-relaxed text-text-muted pt-1 whitespace-pre-line"
                  >{problem}</span
                >
              </li>
            {/each}
        ...
        <div class="flex flex-col gap-4">
          <div class="flex items-start gap-3">
            <span
              class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-brand-green font-body text-xs font-bold text-white"
            >
              1
            </span>
            <div class="flex flex-col gap-1">
              <h4 class="font-body text-base font-bold tracking-wide text-text-primary">
                情報が整理されておらず、目的に素早く届かない。
              </h4>
              <p class="font-body text-xs leading-relaxed text-text-muted">
                不動産投資用マンション／リノベーション／マンション管理など多数の事業に関する各情報をユーザーが「探す」ため、認知負荷がかかりユーザーのペインになっている。
              </p>
            </div>
          </div>
          <img
            src="/project/real-estate/info-scatter-diagram.webp"
            alt="立場別ユーザー（不動産投資・リノベーション・マンション入居者・金融機関）が必要な情報を探し『情報はどこだ？』となる様子と、サイト内に情報が分散・重複している現状を示す図解"
            width="1174"
            height="843"
            class="w-full rounded-lg"
            loading="lazy"
        ...
        <div class="flex flex-col gap-4">
          <div class="flex items-start gap-3">
            ...
            <div class="flex flex-col gap-1">
              ...
              <p class="font-body text-xs leading-relaxed text-text-muted">
                お知らせ・社内情報の公開で同一のものが公開されている、各種のコンテンツへの質疑応答が散在している等、各ページごとに似通ったものが配置されている。
              </p>
            </div>
          </div>
          <img
            src="/project/real-estate/cms-duplication-diagram.webp"
            alt="お知らせと社内情報の公開で同じ「〇〇セミナーのご案内」が別々に管理され、CMSで同一記事が二重管理状態になっていたことを示す図解"
            width="1173"
            height="506"
            class="w-full rounded-lg"
            loading="lazy"
        ...
        <!-- 事業者（クライアント）の課題 -->
        <div
          class="flex flex-col gap-3 rounded-r-lg border-l-4 border-border-primary bg-surface-base p-4"
        >
          <h3 class="font-body text-base font-medium text-text-primary">
            事業者（クライアント）の課題
          </h3>
          <ol class="flex list-decimal flex-col gap-2 pl-5">
            <li class="font-body text-sm leading-relaxed text-text-muted">
              更新頻度の高いコンテンツであるにもかかわらず、外部委託している制作会社の更新対応が遅いので反映に時間がかかる。
            </li>
            <li class="font-body text-sm leading-relaxed text-text-muted">
              CMSの管理が煩雑になっており、サイト内に情報が散在・重複しているため、回遊していると迷子になる。
            </li>
          </ol>
        </div>
        ...
        <div class="flex flex-col gap-4">
          <div class="flex items-start gap-3">
            ...
            <div class="flex flex-col gap-1">
              ...
              <p class="font-body text-xs leading-relaxed text-text-muted">
                修正指示から本番反映まで事業者と委託会社の複数工程を経るため、軽微な更新でも1〜2週間程度を要していた。
              </p>
            </div>
          </div>
          <img
            src="/project/real-estate/client-update-flow.webp"
            alt="情報更新フロー：01 修正指示書の作成（約2〜3時間）→ 02 委託先へ依頼（約1時間）→ 03 委託先が対応（約1〜1.5週間）→ 04 確認・本番反映（約1〜2日）。委託を挟むため反映に時間がかかることを示す図解"
            width="1173"
            height="273"
            class="w-full rounded-lg"
            loading="lazy"
        ...
        <div class="flex flex-col gap-4">
          <div class="flex items-start gap-3">
            ...
            <div class="flex flex-col gap-1">
              <h4 class="font-body text-base font-bold tracking-wide text-text-primary">
                自社の特色やイメージが伝わりづらいビジュアル
              </h4>
              <p class="font-body text-xs leading-relaxed text-text-muted">
                ターゲットである「富裕層」に好まれる上品さや、「人に寄り添った提案」という社内の温度感が感じられるサイトが望ましいが、現状のビジュアルでは表現しきれていない。
              </p>
            </div>
          </div>
          <img
            src="/project/real-estate/company-visual.webp"
            alt="現行の会社情報・アクセス・沿革ページのスクリーンショット。情報は整っているが、富裕層向けの上品さや人の温度感が伝わりづらい現状を示す"
            width="1173"
            height="607"
            class="w-full rounded-lg"
            loading="lazy"
