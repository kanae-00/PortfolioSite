...
export const projectsList: Project[] = [
  {
    ...
    detail: {
      ...
      background: {
        ...
        userProblems: [
          '情報が整理されておらず、目的に素早く届かない\nまた、情報が一律に並列配置されており、目的に合った情報を素早く見つけられない',
          'サイト内に情報が散在、重複しているためサイト内で回遊していると迷子になる',
        ],
        existingIssues: [
      ...
      goals: {
        ...
        constraints: [
          'ユースケース毎の動線を整理する',
          'サーバー移行期間（7ヶ月）以内にリニューアルを完了させる',
          '運用担当者がCMS上で情報更新を容易に扱えるようにする',
        ],
      },
      ...
      infoArchitecture: {
        screenStructure:
          'トップページを起点に、利用目的別の導線を明確化。サービス情報・会社情報・採用情報の境界を整理し、各情報カテゴリが混在しない構造とした。',
        flowDescription:
      ...
      useCases: {
        scenarios: [
          {
            title: 'マンション入居者が入居中にお問合せをする',
            steps: [
              'トップページから「ご入居様向け」を選択',
              'よくある質問（Q&A）ページへ遷移',
              '質問事項に記載がない場合、お問合せフォームからお問合せ',
            ],
          },
          {
            title: '投資検討者が投資用物件の購入を検討する',
            steps: [
              'トップページから「投資用ワンルームマンション」を選択',
              '販売実績や物件情報を閲覧',
              '問い合わせフォームから資料請求',
            ],
          },
...

  {
    ...
    detail: {
      overview: {
        ...
        conceptImage: {
          src: '/project/attendance-expense/overview-concept.webp',
          alt: '勤怠経費管理システムのコンセプト：紙から、なめらかなDXへ。モバイル入力と可視化した承認フローで対応漏れと工数を削減',
        },
      },
      ...
      uiComponents: {
        ...
        sections: [
          ...
          { title: 'Table', images: ['/project/attendance-expense/table-components.webp'] },
        ],
...

  {
    ...
    detail: {
      overview: {
        ...
        conceptImage: {
          src: '/project/publising/overview-concept.webp',
          alt: '出版業界サイトリニューアルのコンセプト：散らばる情報を、ひとつの本棚に。WordPress統合と検索体験の刷新で探す負荷を最小化',
        },
      },
      ...
      uiComponents: {
        ...
        sections: [
          ...
          { title: 'Form', images: ['/project/publising/form-component.webp'] },
        ],
